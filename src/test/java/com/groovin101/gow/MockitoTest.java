...
public class MockitoTest {
    ...
    public void heyDummy() {
        ...
        when(mockedList.get(0)).thenReturn("first val"); //behave a certain way on method call (when get is called here)
        assertEquals("first val", mockedList.get(0));
        verify(mockedList).get(anyInt()); //verify that get(int) method was indeed called
    }
